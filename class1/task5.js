...
//print all the car brands using do while loop
let i = 0;
do {
    console.log(cars[i].brand);
    i++;
} while (i < cars.length);
//print all the car models using do while loop
i = 0;
do {
    console.log(cars[i].model);
    i++;
} while (i < cars.length);
//print all red color cars using do while loop
i = 0;
do {
    if (cars[i].color === "Red") {
        console.log(cars[i]);
...
//print all cars whose price is less than 1000000 using do while loop
i = 0;
do {
