...
//print all the car brands using for loop
for(let i=0; i<cars.length; i++){
    console.log(cars[i].brand);
}
//print all the car models using for loop
for(let i=0; i<cars.length; i++){
    console.log(cars[i].model);
}
//print all red color cars using for loop
for(let i=0; i<cars.length; i++){
    if(cars[i].color=="Red"){
        console.log(cars[i]);
    }
}
//print all cars whose price is less than 1000000 using for loop
for(let i=0; i<cars.length; i++){
